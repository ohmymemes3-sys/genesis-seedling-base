    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-secondary to-primary">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          {/* Location badge */}
          <div className="inline-flex items-center gap-2 bg-background/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-delay">
            <Button 
              ...
              className="bg-background text-primary hover:bg-background/90 shadow-xl px-8 py-6 text-lg font-semibold rounded-xl transition-all hover:scale-105"
            >
              View Pricing
            </Button>
            <Button 
              ...
              className="bg-transparent border-2 border-background text-primary-foreground hover:bg-background/10 px-8 py-6 text-lg font-semibold rounded-xl"
            >
              Get Directions
            </Button>
          </div>
